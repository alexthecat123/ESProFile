// Pin definitions for the ESProFile board (both internal and external versions)
...
// The values below are for the standard ESP32; no need to change them in your pin definition file unless you're using a different ESP32 family
#define TIMG1_WDT_WE 0x050D83AA1
#define TIMG1_WDT_WE_REG 0x3FF60064

// Watchdog timer configuration register and enable bit
// Same goes for these; they're for the standard ESP32 but will need to be changed if you're using a different ESP32 family
