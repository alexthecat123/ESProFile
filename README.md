...
Allows you to search the entirety of your drive for a string of hex bytes, a string of text, or the full contents of the data buffer. It will ask you which of these you want to seach for, and then ask you for your desired string if you choose one of the first two. Then sit back and wait while it searches the drive. It will print the block numbers where it found any matches as it goes.
